...
## Project Structure
    ...
    ├── testapiautosetting_125071  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125071`
...
2. Clone this repo and `cd testapiautosetting_125071`
